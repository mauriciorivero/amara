...
class Madre implements JsonSerializable
{
    // Atributos privados
    private ?int $id;
    ...
    public function jsonSerialize(): mixed
    {
        return [
            ...
            'telefonoPareja' => $this->telefonoPareja,
            'deAcuerdoAborto' => $this->deAcuerdoAborto,
            ...
            'eps' => $this->eps,
            'sisben' => $this->sisben,
            'enfermedadesMedicamento' => $this->enfermedadesMedicamento,
            'seEnteroPor' => $this->seEnteroPor,
            'orientadoraId' => $this->orientadoraId,
            'orientadora' => $this->orientadora,
            'aliadoId' => $this->aliadoId,
            'aliado' => $this->aliado,
            'asisteDiscipulado' => $this->asisteDiscipulado,
            'desvinculo' => $this->desvinculo,
