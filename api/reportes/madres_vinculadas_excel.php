...
try {
    ...
    // Obtener todas las madres vinculadas (activas)
    ...
    $sheet->setTitle('Madres Vinculadas');
    ...
    foreach ($madres as $madre) {
        ...
        $sheet->setCellValue('Z' . $row, $madre->getNovedades());
        $row++;
    }
    ...
    // Generar archivo
    $filename = 'madres_vinculadas_' . date('Y-m-d_His') . '.xlsx';
