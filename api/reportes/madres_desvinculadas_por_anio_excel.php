...
try {
    ...
    // Obtener madres desvinculadas del año especificado
    $sql = "SELECT m.*, 
            ...
            WHERE m.desvinculo IS NOT NULL AND m.desvinculo != ''
    ...
    $sheet->setTitle('Madres Desvinculadas ' . $anio);
    ...
    // Estilo de encabezados (rojo para desvinculadas)
    $headerStyle = [
    ...
    // Generar archivo
    $filename = 'madres_desvinculadas_' . $anio . '_' . date('Y-m-d_His') . '.xlsx';
